        ...
        contactForm.addEventListener('submit', async function(e) { 
            ...
            if (!window.zappyContactFormLoaded) {
                ...
                try {
                    ...
                    const zappyPayload = {
                        websiteId: '801b8eb7-d5f5-47f8-8b78-499831649875',
                        name: formDataObject.name || formDataObject.fullName || formDataObject.userName || '',
                        email: formDataObject.email || formDataObject.userEmail || '',
                        subject: formDataObject.subject || 'Contact Form Submission',
                        message: formDataObject.message || formDataObject.comments || formDataObject.description || '',
                    ...
                    if (response.ok) {
                        ...
                        console.error('❌ Zappy: Server responded with error', response.status, response.statusText);
                    }
                } catch (error) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רוימי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
